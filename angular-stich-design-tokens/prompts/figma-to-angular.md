...
# OBJETIVO
Analisar a imagem de alta fidelidade do Figma (@extrato-pix.png) e as especificações de layout (@figma-specs.txt) para gerar um Standalone Component Angular que renderize essa lista de transações.
